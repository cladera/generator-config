# NodeJS Environment settings [![Build Status](https://secure.travis-ci.org/cladera/generator-config.png?branch=master)](https://travis-ci.org/cladera/generator-config)
